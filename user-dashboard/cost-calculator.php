            ...
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                ...
                <img class="calculator-icon" src="assets/img/calculator.png" alt="Calculator" />
                  <p style="<?php echo  $current_file_name == 'cost-calculator.php' ? 'color: #E87946 !important' : ''; ?>">Cost Calculator</p>
                </a>
              </li> 
			  <li class="nav-item">
					 ...
					 <div>
						<div class='cost-Calculator'> 
							...
							<div class="cost-buttons"> 
							 <p style='line-height: 20px; text-align: center;   color: #fff'>Please note: Packages exceeding $100 USD in value will attract customs duties or fees upon arrival.</p>
