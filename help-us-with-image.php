<?php
// Help page with image using the same layout as about-us.php
?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
<section class="py-3 py-md-5 aboutUs">
  <div class="container">
    <div class="row gy-3 gy-md-4 gy-lg-0 align-items-start">
      <div class="col-12 col-lg-6 img col-xl-5 sticky-side-block">
        <img class="img-fluid rounded" loading="lazy" src="assets/img/contact-page.png" alt="Help Image">
      </div>
      <div class="col-12 col-lg-6 col-xl-7">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            <h2>You’ve Signed Up — Now What?</h2>
            <p class="lead fs-4 aboutUs-subtitle mb-3">
			  Welcome to the Pync Chateau! 🎉 Now that you’ve joined the family, here’s what happens next.
			</p>
