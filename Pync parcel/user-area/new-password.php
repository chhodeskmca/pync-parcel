...
<div class="container" id='container'>
  <div class="card" style="width:400px;">
    <img class="card-img-top" src="https://practice.freelancerhanip.com/final_pyncparcel_manageme/assets/img/logo.png" alt="Card image" style="width: 220px; margin:auto">
    <div class="card-body">
      	     <form action="https://practice.freelancerhanip.com/final_pyncparcel_manageme/user-area/new-password.php?token_hash=<?php echo $token_hash ?>" method="GET">
		   ...
		   if( $("#Verifypwd[name='pwd']").attr('type') == 'password'){
			...
			if( $new_pwd.length >= 8  && /[A-Z]/.test( $new_pwd  ) )  {  
					...
					if( $new_pwd == $Verify_pwd ){ 
					   ...
					   $('#VerifyPassword p').css('color', 'red'); //checking password, if less than 8. adding red border or color.
