            ...
            <div class="row">
               <div class="col-md-offset-1 col-md-12">
                        ...
                        <tbody>
                              ...
                              <?php 
                                    ...
                                    while( $rows = mysqli_fetch_assoc($result)   ){ 
                                              ...
                                              if( $rows['Role_As'] == 1 ){ 
                                                  continue; // You are admin
                                                } ; 
                                               // `id``FName``LName``````Password_Hash``Password_Hash````Role_As````Create_At`
                            ...
                            <tr>
                                ...
                                <td><span style="background: #dc2626;  padding: 4px; border-radius: 5px;  color: #ffffffe5;">unverified</span></td>
						    ...
						    <!--<tr>
                                <td>Pync-12902</td>
                                <td>Jessica  Lindo</td>
                                <td>jesslindo123@gmail.com</td>
                                <td><span style="background:green;padding: 4px; border-radius:5px;color:#ffffffe5;">verified</span></td>
                                <td>Hagley Park</td>
                                <td>+18768892615</td>
                                <td>1 Month ago</td>
                                <td>
                ...
                <?php  
                         ...
                         echo "<p style='text-align: center;font-size: 22px;'> No Pre-alert available</p>";
